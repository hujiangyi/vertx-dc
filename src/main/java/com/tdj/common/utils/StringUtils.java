...
import com.tdj.common.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
   ...
   * @date 2022/6/28
   */
  public static String toFixedStr(int length, String target) {
   ...
   * @Param [template]
   **/
  public static Integer getDiscountvalueInt(String discountValue) {
    //提取数字
    String regEx = "[^0-9]";
    Pattern p = Pattern.compile(regEx);
    Matcher m = p.matcher(discountValue);
    Integer discountvalueInt = Integer.valueOf(m.replaceAll("").trim());
